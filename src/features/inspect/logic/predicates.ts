...
// Transport/unclassified spans hidden by default in the tree and span palette.
export const isCollapsibleInfra = (s: Span): boolean =>
  s.operation === 'http' || s.operation === 'unknown' || s.operation === 'mcp'
