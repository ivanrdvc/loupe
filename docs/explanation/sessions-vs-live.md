...
| Support a new tokenizer family                                 | Extend the encoder resolution in `src/lib/spans/tokens.ts` (currently Anthropic vs o200k-estimate). Lazy-load the encoder data                                                                                                               |
